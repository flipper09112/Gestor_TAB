...
import static com.example.gestor_tab.database.DataBaseUtil.deleteAllLogs;
import static com.example.gestor_tab.database.DataBaseUtil.getLogsClient;
...
public class ClienteActivity extends AppCompatActivity {
    ...
    private void setDataOnScreen(boolean clienteWithRegisto) {
        ...
        this.tabelaPrecos = DataBaseUtil.getTabela(getApplicationContext());
        ...
        if (cliente.getCoordenadas() != null)
            editText.setText(cliente.getCoordenadas());
        else
    ...
    public void saveEncomenda(View view) {
        ...
        if (encomenda)
            DataBaseUtil.logs(this, 3, cliente.getId(), text);
