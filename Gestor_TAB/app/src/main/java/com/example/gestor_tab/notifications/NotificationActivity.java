...
public class NotificationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DataBaseUtil.getEncomenda(file, encomendaManager);
        ...
        if (encomenda.getEncomendaBolosArrayList().isEmpty()) {
            ...
            listaEncomendas.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(final AdapterView<?> adapterView, View view, int i, long l) {
                    ...
                    final LinearLayout linearLayout = new LinearLayout(NotificationActivity.this);
                    linearLayout.setOrientation(LinearLayout.VERTICAL);

                    for (int tipoBolo : encomendaBolos.getTipoBolos()) {
                        final LinearLayout linearLayoutHorizontal = new LinearLayout(NotificationActivity.this);
                    ...
                    AlertDialog alertDialog = new AlertDialog.Builder(NotificationActivity.this)
    ...
    private void setEncomendasDiaSeguinte() {
        ...
        RegistosManager registosManager = DataBaseUtil.getAllLogsEncomendas(getApplicationContext(), amanha.getTime());
    ...
    public void sendEmail(View view) {
        ...
        DataBaseUtil.saveEncomenda(file, encomendaManager);
